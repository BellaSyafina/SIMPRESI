                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/images/dashboard/project/1.png"
                                                        alt=""></div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/images/dashboard/project/2.png"
                                                        alt=""></div>
                                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/images/dashboard/project/3.png"
                                                        alt=""></div>
                                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/images/dashboard/project/4.png"
                                                        alt=""></div>
                                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                            ...
                            <div class="col-5">
                                <ul class="appointments-user">
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img
                                                src="{{ asset('') }}assets/images/dashboard/user/05.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>John Elliot</h5>
                                            </a>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img
                                                src="{{ asset('') }}assets/images/dashboard/user/06.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>Ashley Hart</h5>
                                            </a>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img
                                                src="{{ asset('') }}assets/images/dashboard/user/07.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>Anna lverson</h5>
                                            </a>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img
                                                src="{{ asset('') }}assets/images/dashboard/user/08.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>Dana Lemon</h5>
                                            </a>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/images/dashboard/user/01.jpg"
                                                        alt=""></div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/images/dashboard/user/02.jpg"
                                                        alt=""></div>
                                                <div class="flex-grow-1"><a href="product.html">
                                                        <h5>Ashley Hart</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/images/dashboard/user/03.jpg"
                                                        alt=""></div>
                                                <div class="flex-grow-1"><a href="product.html">
                                                        <h5>Anna lverson </h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/images/dashboard/user/04.jpg"
                                                        alt=""></div>
                                                <div class="flex-grow-1"><a href="product.html">
                                                        <h5>Ron Dayley</h5>
                    ...
                    <div class="card-body sale-statistic">
                        <div class="row">
                            ...
                            <div class="col-3 statistic-icon">
                                <div class="light-card balance-card widget-hover">
                                    <div class="icon-box"><img
                                            src="{{ asset('') }}assets/images/dashboard/icon/revenue.png"
                                            alt=""></div>
                            ...
                            <div class="col-3 statistic-icon">
                                <div class="light-card balance-card widget-hover">
                                    <div class="icon-box"><img
                                            src="{{ asset('') }}assets/images/dashboard/icon/profit.png"
                                            alt=""></div>
